...
export default function CouncilBody() {
  return (
    <section className="mt-[44px] mb-[60px]">
      ...
      <div className="w-full bg-white pt-[74px] rounded-bl-[20px] rounded-br-[20px] p-8">
        <div className="grid grid-cols-2 gap-8">
          <div className="relative">
            <div className="bg-amber-400 rounded-[10px] w-[400px] h-[360px] mx-auto">
      ...
      <div className="w-full bg-white rounded-bl-[20px] rounded-br-[20px] p-8">
        <div className="grid grid-cols-2 gap-8">
          <div className="relative">
            <div className="bg-amber-400 rounded-[10px] w-[400px] h-[360px] mx-auto">
              <div className="absolute left-[50%] transform -translate-x-1/2 top-[55px] w-32 h-32 bg-stone-300 rounded-full"></div>
