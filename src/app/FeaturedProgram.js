...
function FeaturedProgram() {
  return (
    <div className="w-full h-[767px]  bg-white  justify-start items-start">
      ...
      <div className="flex items-center px-8 gap-20 justify-center flex-row">
        <div className="flex flex-col justify-start items-start gap-[35px]">
          <Image
            ...
            alt="Leadership"
          />
          <div className="flex flex-col text-start justify-start gap-3">
            ...
            <div className="flex  gap-2">
              <div className="text-emerald-600 cursor-pointer text-start text-2xl font-normal font-calibri underline leading-loose">
                Read more
              </div>
            </div>
          </div>
        </div>
        <div className=" w-[378px] h-[435px] flex flex-col justify-start items-start gap-[41px]">
          <Image
            width={365}
            height={236}
            quality={100}
            ...
            alt="Arts"
          />
          <div className="w-[365px] text-center text-sky-950 text-2xl font-bold font-calibri leading-7">
            Entrepreneurship
          </div>
