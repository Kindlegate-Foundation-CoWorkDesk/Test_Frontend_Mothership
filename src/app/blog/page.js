  ...
  return (
    <section>
      <main className="relative">
        ...
        <div className="w-[589px] absolute top-[327.59px] left-[164.25px] h-[184px] flex-col gap-[30px] flex">
          <div className=" text-center text-zinc-100 text-[64px] font-bold font-calibri  leading-[64px]">
            BLOG
          </div>
          <div className="self-stretch text-center text-zinc-100 text-xl font-normal font-calibri w-[589px] leading-snug">
