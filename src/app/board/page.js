...
export default function Home() {
  return (
    <section className="overflow-hidden">
      <BoardPage />
      <section className="w-full md:h-[1600px] font-calibri">
      ...
      <section className=" bg-sky-900 rounded-bl-[20px] rounded-br-[20px] font-calibri">
        <div className="w-full md:max-w-[1000px] mx-auto mt-10">
          <div className=" p-8 md:p-20 w-full ">
            <h1 id="advisory" className="uppercase  text-center text-white text-[22px]  md:text-4xl font-bold">
              The Advisory Board
            </h1>
            <div className="w-[125px] h-[0px] border-4 border-amber-400 mx-auto"></div>
          </div>
