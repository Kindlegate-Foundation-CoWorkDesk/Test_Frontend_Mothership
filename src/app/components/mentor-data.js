...
const MentorData = () => {
  return (
    <section className="w-full h-[780px] font-calibri">
      <div className="w-full mx-auto">
        <div>
          <h3 className="text-[36px] font-calibri font-bold text-[#14242C] text-center">
            Meet Our Mentors
          </h3>
        ...
        <div className="flex items-center justify-between max-w-[1200px]  mx-auto  w-full mt-28">
          <div>
            <div>
              ...
              <h1 className="font-bold text-[32px] font-calibri text-center text-[#14242C] border-[#E3B522]">
                LOREM IPSUM
              </h1>
