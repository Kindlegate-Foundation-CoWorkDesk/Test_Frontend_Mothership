  ...
  return (
    <section>
      <main className="relative overflow-hidden">
        ...
        <div className="w-[589px] absolute top-[252px] left-[164.25px] h-[184px] flex-col gap-[30px] flex">
          <div className=" text-start text-zinc-100 font-calibri text-[64px] font-bold  leading-[64px]">
            OUR VOLUNTEERS
          </div>
          <div className="self-stretch w-[589px] text-center text-zinc-100 text-xl font-normal font-calibri leading-snug">
